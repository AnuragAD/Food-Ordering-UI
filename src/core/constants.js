...
export const CAROUSEL_IMG_CDN_URL = "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_520,h_520/";//rng/md/carousel/production/pneknawbadtvceqzwiep";

export const PLACE_AUTOCOMPLETE_URL =
  "https://www.swiggy.com/dapi/misc/place-autocomplete?input=";

export const RECOMMENDED_ADDRESS_URL =
  "https://www.swiggy.com/dapi/misc/address-recommend?place_id=";

export const RESTAURANT_LIST_BASED_ON_LOACTION =
